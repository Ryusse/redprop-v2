export function validateFirstName(first_name: unknown): [string?, undefined?] {
	if (
		!first_name ||
...
export function validateLastName(last_name: unknown): [string?, undefined?] {
	if (
		!last_name ||
...
export function validateDni(dni: unknown): [string?, undefined?] {
