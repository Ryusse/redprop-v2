export class DeleteMultipleConsultationsDto {
	private constructor(public readonly consultation_ids: number[]) {}

	static create(
		object: Record<string, unknown>,
	): [string?, DeleteMultipleConsultationsDto?] {
		...
		return [undefined, new DeleteMultipleConsultationsDto(consultation_ids)];
	}
}
