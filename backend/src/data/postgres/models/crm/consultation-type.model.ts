...
export class ConsultationTypeModel {
    ...
    static async create(data: CreateConsultationTypeDto): Promise<ConsultationType> {
    ...
    static async update(id: number, updateData: Partial<CreateConsultationTypeDto>): Promise<ConsultationType | null> {
        const client = PostgresDatabase.getClient();
        if (!updateData.name) {
