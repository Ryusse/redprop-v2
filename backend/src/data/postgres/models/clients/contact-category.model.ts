...
export class ContactCategoryModel {
    ...
    static async create(data: CreateContactCategoryDto): Promise<ContactCategory> {
    ...
    static async update(id: number, updateData: Partial<CreateContactCategoryDto>): Promise<ContactCategory | null> {
        const client = PostgresDatabase.getClient();
        if (!updateData.name) {
