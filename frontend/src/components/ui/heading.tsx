...
const headingVariants = cva("font-bold font-mono text-heading", {
	variants: {
		variant: {
			h1: "text-[2.5rem] leading-[1.2] lg:text-[3.3125rem]", // 53px
			h2: "text-[1.5rem] leading-[1.2] lg:text-[2.5rem]", // 40px
			h3: "text-[1.5rem] leading-[1.2] lg:text-[1.9375rem]", // 31px
			subtitle1: "text-[1.5rem] leading-[1.2]", // 24px
			subtitle2: "text-lg leading-[1.2] lg:text-[1.25rem]", // 20px
