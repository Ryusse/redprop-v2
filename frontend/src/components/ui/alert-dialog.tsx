		...
		<AlertDialogPortal>
			...
			<AlertDialogPrimitive.Content
				...
				className={cn(
					[
						// Base
						"fixed top-[50%] left-[50%] z-50 grid w-full max-w-[calc(100%-2rem)] translate-x-[-50%] translate-y-[-50%] gap-4 rounded-lg border bg-card p-6 shadow-lg duration-200 sm:max-w-lg",
						// Animations
		...
		return (
			<div className="flex items-center gap-4" {...props}>
				...
				<div
					...
					className={cn(
						"flex flex-col gap-2 space-y-1 text-start sm:text-left",
						className,
					)}
				>
					{children}
